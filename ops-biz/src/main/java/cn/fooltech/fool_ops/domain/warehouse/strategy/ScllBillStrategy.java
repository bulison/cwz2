 ...
 */
@Component("ops.ScllBillStrategy")
public class ScllBillStrategy implements BillStrategy {
    ...
    */
    private List<CalMethod> auditTotalMethods = Lists.newArrayList(
            ...
            new CalMethod("materialsQuantity", "materialsQuantity", CalMethod.Compute.Add, "accountQuentity"),
            new CalMethod("materialsAmount", "materialsAmount", CalMethod.Compute.Add, "costAmount")
    ...
    */
    private List<CalMethod> cancleTotalMethods = Lists.newArrayList(
            ...
            new CalMethod("materialsQuantity", "materialsQuantity", CalMethod.Compute.Sub, "accountQuentity"),
            new CalMethod("materialsAmount", "materialsAmount", CalMethod.Compute.Sub, "costAmount")
    );
    ...
    */
    ...
    public boolean isSupport(int billType) {
        return billType == WarehouseBuilderCodeHelper.scll;
    }
