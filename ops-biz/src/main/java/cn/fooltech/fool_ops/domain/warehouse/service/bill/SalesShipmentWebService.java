 ...
 * @date 2015年9月24日
 */
@Service("ops.SalesShipmentWebService")
public class SalesShipmentWebService extends BaseWarehouseWebServiceBuilder{
	
	@Override
	@Value("#{T(cn.fooltech.fool_ops.domain.warehouse.util.WarehouseBuilderCode).xsch}")
