 ...
 */
@Component("ops.CgthBillStrategy")
public class CgthBillStrategy implements BillStrategy {
    ...
    */
    private List<CalMethod> auditTotalMethods = Lists.newArrayList(
            ...
            new CalMethod("purchaseReturnQuantity", "purchaseReturnQuantity", CalMethod.Compute.Add, "accountQuentity"),
            new CalMethod("purchaseReturnAmount", "purchaseAmount", CalMethod.Compute.Add, "costAmount")
    ...
    */
    private List<CalMethod> cancleTotalMethods = Lists.newArrayList(
            ...
            new CalMethod("purchaseReturnQuantity", "purchaseReturnQuantity", CalMethod.Compute.Sub, "accountQuentity"),
            new CalMethod("purchaseReturnAmount", "purchaseReturnAmount", CalMethod.Compute.Sub, "costAmount")
    ...
    */
    ...
    public boolean isSupport(int billType) {
        return billType == WarehouseBuilderCodeHelper.cgth;
    }
