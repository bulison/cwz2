 ...
 */
@Component("ops.CgrkBillStrategy")
public class CgrkBillStrategy implements BillStrategy {
    ...
    */
    private List<CalMethod> auditTotalMethods = Lists.newArrayList(
            ...
            new CalMethod("purchaseQuantity", "purchaseQuantity", CalMethod.Compute.Add, "accountQuentity"),
            new CalMethod("purchaseAmount", "purchaseAmount", CalMethod.Compute.Add, "type")
    ...
    */
    private List<CalMethod> cancleTotalMethods = Lists.newArrayList(
            ...
            new CalMethod("purchaseQuantity", "purchaseQuantity", CalMethod.Compute.Sub, "accountQuentity"),
            new CalMethod("purchaseAmount", "purchaseAmount", CalMethod.Compute.Sub, "type")
    ...
    */
    ...
    public boolean isSupport(int billType) {
        return billType == WarehouseBuilderCodeHelper.cgrk;
    }
