 ...
 */
@Component("ops.XschBillStrategy")
public class XschBillStrategy implements BillStrategy {
    ...
    */
    private List<CalMethod> auditTotalMethods = Lists.newArrayList(
            ...
            new CalMethod("saleQuantity", "saleQuantity", CalMethod.Compute.Add, "accountQuentity"),
            new CalMethod("saleAmount", "saleAmount", CalMethod.Compute.Add, "costAmount")
    ...
    */
    private List<CalMethod> cancleTotalMethods = Lists.newArrayList(
            ...
            new CalMethod("saleQuantity", "saleQuantity", CalMethod.Compute.Sub, "accountQuentity"),
            new CalMethod("saleAmount", "saleAmount", CalMethod.Compute.Sub, "costAmount")
    );
    ...
    */
    ...
    public boolean isSupport(int billType) {
        return billType == WarehouseBuilderCodeHelper.xsch;
    }
