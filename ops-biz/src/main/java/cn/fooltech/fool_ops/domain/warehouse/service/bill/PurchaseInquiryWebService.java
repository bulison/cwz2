 ...
 * @date 2015年10月6日
 */
@Service("ops.PurchaseInquiryWebService")
public class PurchaseInquiryWebService extends BaseWarehouseWebServiceBuilder {
	...
	@Override
	@Value("#{T(cn.fooltech.fool_ops.domain.warehouse.util.WarehouseBuilderCode).cgxjd}")
	...
	public RequestResult cancel(String id) {
		...
		try {
			...
			e.printStackTrace();
			return buildFailRequestResult("采购询价作废出错!");
		}
		return result;
	}
