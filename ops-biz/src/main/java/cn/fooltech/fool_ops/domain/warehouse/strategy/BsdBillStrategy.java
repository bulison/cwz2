 ...
 */
@Component("ops.BsdBillStrategy")
public class BsdBillStrategy implements BillStrategy {
    ...
    */
    private List<CalMethod> auditTotalMethods = Lists.newArrayList(
            ...
            new CalMethod("lossQuantity", "lossQuantity", CalMethod.Compute.Add, "accountQuentity"),
            new CalMethod("lossAmount", "lossAmount", CalMethod.Compute.Add, "costAmount")
    ...
    */
    private List<CalMethod> cancleTotalMethods = Lists.newArrayList(
            ...
            new CalMethod("lossQuantity", "lossQuantity", CalMethod.Compute.Sub, "accountQuentity"),
            new CalMethod("lossAmount", "lossAmount", CalMethod.Compute.Sub, "costAmount")
    );
    ...
    */
    ...
    public boolean isSupport(int billType) {
        return billType == WarehouseBuilderCodeHelper.bsd;
    }
