 ...
 * @date 2015年10月6日
 */
@Service("ops.SaleOutStockWebService")
public class SaleOutStockWebService extends BaseWarehouseWebServiceBuilder{
	@Autowired
	...
	@Override
	@Value("#{T(cn.fooltech.fool_ops.domain.warehouse.util.WarehouseBuilderCode).xsdd}")
	...
	public RequestResult cancel(String id) {
		...
		try {
			...
			e.printStackTrace();
			return buildFailRequestResult("销售订单作废出错!");
		}
		return result;
	}
