 ...
 * @date 2015年12月14日
 */
@Service("ops.ProductionReturnWebService")
public class ProductionReturnWebService extends BaseWarehouseWebServiceBuilder{
	
	
	@Override
	@Value("#{T(cn.fooltech.fool_ops.domain.warehouse.util.WarehouseBuilderCode).sctl}")
