...
public class CustomerVo implements Serializable {
    ...
    private static final long serialVersionUID = 6462782184961003670L;
    /**
     * ID
     */
    private String fid;
    ...
    @Length(max = 100, message = "简称长度超过{max}个字符")
    private String shortName;
    /**
     * 地区ID
     */
    @ApiModelProperty(value = "地区ID")
    @Length(max = 32, message = "地区长度超过{max}个字符")
    ...
    @Length(max = 32, message = "类别长度超过{max}个字符")
    ...
    @Length(max = 19, message = "用户配置信用额度长度超过{max}个字符")
    private String creditLineUser;
    /**
     * 系统计算信用额度
     */
    @ApiModelProperty(value = "系统计算信用额度")
    @Length(max = 19, message = "系统计算信用额度长度超过{max}个字符")
    private String creditLineSys;
    /**
     * 业务联系人
     */
    @ApiModelProperty(value = "业务联系人")
    @Length(max = 50, message = "业务联系人长度超过{max}个字符")
    private String businessContact;
    /**
     * 业务联系人传真
     */
    @ApiModelProperty(value = "业务联系人传真")
    @Length(max = 50, message = "业务联系人传真长度超过{max}个字符")
    private String fax;
    /**
     * 业务联系人移动电话
     */
    @ApiModelProperty(value = "业务联系人移动电话")
    @Length(max = 50, message = "业务联系人移动电话长度超过{max}个字符")
...
//	@Email(regexp="^([a-z0-9A-Z]+[-|\\.]?)+[a-z0-9A-Z]@([a-z0-9A-Z]+(-[a-z0-9A-Z]+)?\\.)+[a-zA-Z]{2,}$",message="邮箱格式有误")
    @Length(max = 128, message = " 邮箱地址长度超过{max}个字符")
    private String email;
    /**
     * 地址
     */
    @ApiModelProperty(value = "地址")
    @Length(max = 200, message = "地址长度超过{max}个字符")
    private String address;
    /**
     * 电话
     */
    @ApiModelProperty(value = "电话")
    @Length(max = 50, message = "电话长度超过{max}个字符")
    private String tel;
    /**
     * 业务员ID
     */
    @ApiModelProperty(value = "业务员ID")
    @Length(max = 32, message = "业务员长度超过{max}个字符")
    ...
    @Length(max = 50, message = "法人代表长度超过{max}个字符")
    private String principal;
    /**
     * 法人联系电话
     */
    @ApiModelProperty(value = "法人联系电话")
    @Length(max = 20, message = "法人联系电话长度超过{max}个字符")
    private String principalPhone;
    /**
     * 征信级别ID
     */
    @ApiModelProperty(value = "征信级别ID")
    @Length(max = 32, message = "征信级别长度超过{max}个字符")
...
//	@Pattern(regexp = "[1-9]{1}(\\d+){5}", message = "邮编格式有误")
    @Length(max = 16, message = "邮编长度超过16位")
...
//	@Pattern(regexp = "^(\\d{16}|\\d{19})$", message = "帐号格式有误")
    ...
    private String recordStatus = Customer.STATUS_SAC;
    /**
     * 部门ID
     */
    ...
    /**
     * 默认0；0:所有  1:只查设置了默认地址的客户
     */
    private Integer onlyDefaultAddress = Constants.NOTSHOW;
    ...
    public Integer getOnlyDefaultAddress() {
        return onlyDefaultAddress;
    }

    public void setOnlyDefaultAddress(Integer onlyDefaultAddress) {
        this.onlyDefaultAddress = onlyDefaultAddress;
    }
}
