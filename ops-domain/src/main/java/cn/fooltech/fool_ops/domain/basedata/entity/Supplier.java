...
@ApiModel("供应商")
@Entity
@Table(name = "TBD_SUPPLIER")
public class Supplier extends OpsOrgBaseDataEntity {

    private static final long serialVersionUID = 8702935921202679732L;
