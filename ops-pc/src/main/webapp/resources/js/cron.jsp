...
<head>
  <title>Cron表达式生成器aaa</title>
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <link href="${ctx}/resources/css/base.css" rel="stylesheet" type="text/css" />
    <link href="${ctx}/resources/js/lib/easyui/themes/bootstrap/easyui.css" rel="stylesheet" type="text/css" />
    <link href="${ctx}/resources/js/lib/easyui/themes/icon.css" rel="stylesheet" type="text/css" />
    <link href="${ctx}/resources/css/icon.css" rel="stylesheet" type="text/css" />
    <script src="${ctx}/resources/jquery/js/jquery.min.js" type="text/javascript"></script>
    <script src="${ctx}/resources/js/lib/easyui/jquery.easyui.min.js" type="text/javascript"></script>
    <script src="${ctx}/resources/js/lib/easyui/themes/cron.js" type="text/javascript"></script>
...
<div class="titleCustom">
    ...
    <center>
        <div class="easyui-layout" style="width:500px;height:450px; border: 1px rgb(202, 196, 196) solid;border-radius: 5px;">
            ...
            <div data-options="region:'south',border:false" style="height:150px; width:500px;">
                <fieldset style="border-radius: 3px; height: 116px;" id="result">
                    <legend>表达式</legend>
                    <table style="height: 100px;">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="v_second" class="col" value="*" readonly />
                                </td>
                                <td>
                                    <input type="text" name="v_min" class="col" value="*" readonly />
                                </td>
                                <td>
                                    <input type="text" name="v_hour" class="col" value="*" readonly />
                                </td>
                                <td>
                                    <input type="text" name="v_day" class="col" value="*" readonly />
                                </td>
                                <td>
                                    <input type="text" name="v_mouth" class="col" value="*" readonly />
                                </td>
                                <td>
                                    <input type="text" name="v_week" class="col" value="?" readonly />
                                </td>
                                <td>
                                    <input type="text" name="v_year" class="col" readonly />
                                </td>
                            </tr>
                             <tr>
							    <td>Cron 表达式:</td>
