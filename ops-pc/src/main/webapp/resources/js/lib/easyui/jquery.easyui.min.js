...
var _a3=_a2.options;
var bb=_a2.bb={};
var _a4=$(_a1).addClass("pagination").html("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tr><td><div class=\"pagination-info\"></div></td></tr></table>");
var tr=_a4.find("tr");
...
_b9=_b9.replace(/{currPage}/,_b5.pageNumber);
_b9=_b9.replace(/{pages}/,Math.ceil(_b5.total/_b5.pageSize)||1);
...
},beforePageText:"Page",afterPageText:"of {pages}",displayMsg:" {total} 条记录  {from} / {to} 条",nav:{first:{iconCls:"pagination-first",handler:function(){
...
$.fn.textbox.defaults=$.extend({},$.fn.validatebox.defaults,{width:"auto",height:22,prompt:"",value:"",type:"text",multiline:false,editable:true,disabled:false,readonly:false,icons:[],iconCls:null,iconAlign:"right",iconWidth:22,buttonText:"",buttonIcon:null,buttonAlign:"right",inputEvents:{blur:function(e){
var t=$(e.data.target);
...
var bnum=0;//根据有否固定列来设置列表第一列的mark=1
if("undefined" != typeof opts.frozenColumns && opts.frozenColumns.length != 0){
	_73a?bnum=1:null;
}else{
	bnum=1;
}
...
!col.hidden&&bnum==1?(_742 = _742+" mark=1",bnum--):null;//mark=1让css选择器更容易找出显示的第一列
...
!col.hidden&&fnum==1?(_8a9 = _8a9+" mark=1",fnum--):null;//mark=1让css选择器更容易找出显示的第一列
...
($(_938).combo("panel"))[0].innerHTML = dd.join("");
if(opts.multiple){
_92d(_938,_93b,_939);
}else{
