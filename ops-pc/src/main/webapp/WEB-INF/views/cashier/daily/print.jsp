...
<div id="warp-div">
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            <td id="org-name-area" colspan="100" style="position: relative;">
                ...
                <h2>
                    <c:choose>
                        <c:when test="${code eq 'dzd'}">银行日记账单</c:when>
                    </c:choose>
                </h2>
            </td></tr>
    ...
    <script type="text/javascript">
        ...
        if("undefined" == typeof texts||vals.length==0){
            ...
            //文本区域
            _str = "<tr><td style='text-align:"+_align+";width:"+_width+"%;' colspan='"+texts[0].colspan+"'>单据日期：<span class='val'>"+getDateStr(vals[0]["voucherDate"])+"</span></td>";
            ...
            if(_dt){
                ...
                for(var i=0;i<_dt.length+nullRow;i++){
                    ...
                    for(var j=0;j<thead.length;j++){
                        ...
                        if(j+1==_tlen) {
                            if (thead[j].key == "amount" && _dt[i] != undefined && _dt[i]["debit"] > 0) {
                                _str += "<td width='"+_width+"%' style='text-align:"+_align+";height:17px !important;' class='last-th'>"+tranKey(_dt[i], "debit")+"</td>";
                            } else if (thead[j].key == "amount" && _dt[i] != undefined && _dt[i]["credit"] > 0) {
                                _str += "<td width='"+_width+"%' style='text-align:"+_align+";height:17px !important;' class='last-th'>"+tranKey(_dt[i], "credit")+"</td>";
                            } else {
