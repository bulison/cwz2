...
<p><font>销售订单：</font><input _billCode='xsdd' name="relation" id="relation" value="${obj.relationName}" class="relationBox textBox" type="text" readonly="readonly"/></p><a href="#" title="清除" class="clearBill"><img style="vertical-align:middle;" src="${ctx}/resources/images/cancel.png"></a></p>
...
<p><font>供应商电话：</font><input id="supplierPhone" validType="phone" name="supplierPhone" value="${obj.supplierPhone}" class="textBox" type="text"/></p>
...
<p><font><em>*</em>采购员：</font><input id="inMemberName" name="inMemberName" value="${obj.inMemberName}" class="memberBox textBox" type="text" readonly="readonly"/></p>
...
<br/>
<p style="width: 70%"><font>备注：</font><input validType='maxLength[200]' name="describe" class="textBox" style="width:80%" value="${obj.describe}" type="text"/></p>
<p class="more"><font><a href="javascript:;" onclick="show_more()" class="show-more"></a>其他信息</font></p>
<div class="more-div">
...
${(obj.recordStatus==null||obj.recordStatus==0)?'<a href="javascript:;" class="btn-ora-add" onclick="addGood()" >添加</a>&nbsp;<a href="javascript:;" class="btn-ora-add hide savaAll" onclick="saveAll()" >一键确定</a>':''}
</div>
...
<a id="verify" class="btn-blue btn-s" onclick="passAudit('${obj.fid}')">审核</a>
<a id="print" class="btn-blue btn-s">打印</a>
<a id="refreshForm" class="btn-blue btn-s" onclick="refreshForm()">刷新</a>
<a id="void" class="btn-blue btn-s" onclick="cancelVoid('${obj.fid}')">作废</a> --%>
</div>
...
<fool:tagOpt optCode="cgddAction1">//</fool:tagOpt>$('#save').remove();
<fool:tagOpt optCode="cgddAction5">//</fool:tagOpt>$('#void').remove();
<fool:tagOpt optCode="cgddAction3">//</fool:tagOpt>$('#copyRow').remove();
