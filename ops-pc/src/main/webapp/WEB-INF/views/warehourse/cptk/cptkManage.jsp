...
<body>
	...
	<div style="margin: 10px 0px 0px 0px;">	     
		...
		<form action="" id="search-form">
			...
			<p>出库人:<input id="myInMemberName" name="inMemberName" class="textBox" data-options="{novalidate:true,width:160,height:30}"/>
...
$('#dataTable').jqGrid({
	...
	colModel:[
	  		...
	  		{name:'code',label:'单号',align:"center",width:100,sortable:true,<fool:tagOpt optCode="cptkAction1">formatter:codeLinkNew</fool:tagOpt>},
			...
			{name:'inMemberName',align:"center",label:'出库人',width:100},
        	{name:'inWareHouseName',align:"center",label:'出仓仓库',width:100},
