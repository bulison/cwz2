...
<p><font>凭证号：</font><input name="voucherCode" class="easyui-validatebox" data-options="validType:'maxLength[50]'" id="voucherCode" value="${obj.voucherCode}" data-options="{required:true,novalidate:true}" class="textBox" type="text"/></p>
...
<p><font>成品入库单：</font><input _billCode='cprk' name="relation" id="relation" value="${obj.relationName}" class="relationBox textBox" type="text" readonly="readonly"/></p><a href="#" title="清除" class="clearBill"><img style="vertical-align:middle;" src="${ctx}/resources/images/cancel.png"></a></p>
...
<p><font><em>*</em>仓库：</font><input name="inWareHouseName" _class="warehouse_d" id="inWareHouseName" value="${isDetail ? obj.inWareHouseName : obj.inWareHouseId}" class="textBox" type="text"/></p>
<p><font><em>*</em>出库人：</font><input id="inMemberName" name="inMemberName" value="${obj.inMemberName}" class="memberBox textBox" type="text"/></p>
<br/>
<%-- <p><font>备注：</font><textarea name="describe" class="textArea">${obj.describe}</textarea></p> --%>
<p style="width: 70%"><font>备注：</font><input class="easyui-validatebox" data-options="validType:'maxLength[200]'" name="describe" class="textBox" style="width:80%" value="${obj.describe}" type="text"/></p>
...
<div class="btn-footer" _id="${obj.fid}"></div>
...
<fool:tagOpt optCode="cptkAction1">//</fool:tagOpt>$('#save').remove();
<fool:tagOpt optCode="cptkAction5">//</fool:tagOpt>$('#void').remove();
<fool:tagOpt optCode="cptkAction3">//</fool:tagOpt>$('#copyRow').remove();
