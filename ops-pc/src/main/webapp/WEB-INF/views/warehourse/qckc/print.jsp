		...
		if("undefined" != typeof tfoot){
			...
			for(var i=0;i<tfoot.length;i++){
				...
				if(tfoot[i].dtype==0){//当页统计
					_str += "<td tdata='SubCount' tindex='"+_ind+"' width="+tfoot[i].width+"%>"+tfoot[i].text+"</td>";
				}else if(tfoot[i].dtype==1){//统计全部
					_str += "<td tdata='AllCount' tindex='"+_ind+"' width="+tfoot[i].width+"%>"+tfoot[i].text+"</td>";
				}else if(tfoot[i].dtype==2){//当前页金额
					_str += "<td tdata='SubSum' tindex='"+_ind+"' width="+tfoot[i].width+"% format='0.00'>"+tfoot[i].text+"</td>";
				}else if(tfoot[i].dtype==3){//当前页金额大写
					_str += "<td tdata='SubSum' tindex='"+_ind+"' width="+tfoot[i].width+"% format='UpperMoney'>"+tfoot[i].text+"</td>";
				}else if(tfoot[i].dtype==4){//所有记录总金额
					_str += "<td tdata='AllSum' tindex='"+_ind+"' width="+tfoot[i].width+"% format='0.00'>"+tfoot[i].text+"</td>";
				}else if(tfoot[i].dtype==5){//所有记录总金额大写
					_str += "<td tdata='AllSum' tindex='"+_ind+"' width="+tfoot[i].width+"% format='UpperMoney'>"+tfoot[i].text+"</td>";
				}else{
					_str += "<td>&nbsp;</td>";
				}
			}
