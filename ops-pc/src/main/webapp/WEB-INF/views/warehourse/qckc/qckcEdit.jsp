...
<form action="" class="bill-form myform" id="warehousebillForm">
	...
	<div id="bill" class="shadow" style="margin-top:50px;">
		...
		<div class="in-box" id="list2">
			...
			<p>
				<font>备注：</font><input name="describe" class="textBox" style="width:858px;" value="${obj.describe}" type="text"/>
			</p>
...
var tfoot = [
				{dtype:0,key:'quentity',text:'当页总数#',width:15},
				{dtype:3,key:'type',text:'当页小计&nbsp;#',width:70},
				{dtype:2,key:'type',text:'¥&nbsp;#&nbsp;元',width:15},
				{dtype:1,key:'quentity',text:'总数#',width:15},
				{dtype:5,key:'type',text:'合计&nbsp;#',width:70},
				{dtype:4,key:'type',text:'¥&nbsp;#&nbsp;元',width:15},
			];
<c:choose>
