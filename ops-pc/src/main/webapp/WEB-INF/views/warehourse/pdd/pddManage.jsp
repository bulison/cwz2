		    ...
		    <fool:tagOpt optCode="pddSearch">
	          ...
	          <div class="input_div">
	            <form id="search-form">
	              ...
	              <p>盘点人：<input id="select-inMemberName" _class="inmember-combogrid" name="inMemberName" class="textBox"/><input type="hidden" name="inMemberId" id="select-inMemberId" /></p>
...
$('#billList').jqGrid({
	...
	colModel:[
	  		...
	  		{name:'code',label:'单号',align:"center",sortable:true,width:100,<fool:tagOpt optCode="pddAction1">formatter:codeLinkNew</fool:tagOpt>},
	        ...
	        {name:'inMemberName',label:'盘点员',align:"center",sortable:true,width:100},
	      ...
	      gridComplete:function(){
	    	  	<fool:tagOpt optCode="pddAction2">//</fool:tagOpt>$('.btn-del').remove();
				<fool:tagOpt optCode="pddAction3">//</fool:tagOpt>$('.btn-copy').remove();
				<fool:tagOpt optCode="pddAction4">//</fool:tagOpt>$('.btn-approve').remove();
				<fool:tagOpt optCode="pddAction5">//</fool:tagOpt>$('.btn-cancel').remove();
	    	  warehouseAll();
	      }
