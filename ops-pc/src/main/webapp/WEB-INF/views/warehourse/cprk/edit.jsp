...
<p><font>生产领料单：</font><input _billCode='scll' name="relation" id="relation" value="${obj.relationName}" class="relationBox textBox" type="text" readonly="readonly"/></p><a href="#" title="清除" class="clearBill"><img style="vertical-align:middle;" src="${ctx}/resources/images/cancel.png"></a></p>
...
<p><font><em>*</em>入库人：</font><input id="inMemberName" name="inMemberName" value="${obj.inMemberName}" class="memberBox textBox" type="text"/></p>
<br/>
...
<fool:tagOpt optCode="cprkAction1">//</fool:tagOpt>$('#save').remove();
<fool:tagOpt optCode="cprkAction5">//</fool:tagOpt>$('#void').remove();
<fool:tagOpt optCode="cprkAction3">//</fool:tagOpt>$('#copyRow').remove();
