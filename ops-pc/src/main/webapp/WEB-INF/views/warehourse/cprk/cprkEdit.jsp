...
<form action="" class="bill-form myform" id="warehousebillForm">
	...
	<div id="bill" class="shadow" style="margin-top:50px;">
		...
		<div class="in-box" id="list2">
			...
			<p>
				<font>生产计划单：</font><input _billCode='scjhd' name="relation" id="relation" value="${obj.relationName}" class="relationBox textBox" type="text"/><a href="javascript:;" title="清除" class="clearBill" style="margin-left:-20px;"><img style="vertical-align:middle;" src="${ctx}/resources/images/cancel.png"></a>
				...
				<font>入库人：</font><input _imp="true" _class="member-combogrid" id="inMemberName" name="inMemberName" value="${obj.inMemberName}" class="textBox" type="text"/>
			</p>
			<p>
