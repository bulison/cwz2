...
<input id="saleBill-code" class="easyui-textbox" data-options="prompt:'单据编号',width:100,height:30"/>
...
<table class="easyui-datagrid" id="saleBill-table" data-options="idField:'fid',fitColumns:true,pagination:true,url:'${ctx}/salebill/${param.billCode}/list?recordStatus=1'">
<thead>
<tr>
...
<th data-options="field:'deptName',width:10,sortable:false">部门名称</th>
<th data-options="field:'deptId',width:10,hidden:true,sortable:false">部门ID</th>
<th data-options="field:'inMemberName',width:10,sortable:false">业务员</th>
<th data-options="field:'inMemberId',width:10,hidden:true,sortable:false">业务员ID</th>
<th data-options="field:'endDate',width:10,sortable:false">计划完成时间</th>
<th data-options="field:'totalAmount',width:10,sortable:false">总金额</th>
<th data-options="field:'freeAmount',width:10,hidden:true,sortable:false">免单金额</th>
</tr>
</thead>
</table>
<div id="salewin"></div>
