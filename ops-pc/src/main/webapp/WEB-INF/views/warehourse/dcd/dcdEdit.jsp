...
<form action="" class="bill-form myform" id="warehousebillForm">
	...
	<div id="bill" class="shadow" style="margin-top:50px;">
		...
		<div class="in-box" id="list2">
			...
			<input name="outWareHouseId" id="outWareHouseId" value="${obj.outWareHouseId}" type='hidden'/>
			...
			<p>
				<font>调出仓库：</font><input name="outWareHouseName" _imp="true" _class="outWarehouse" id="outWareHouseName" value="${isDetail ? obj.outWareHouseName : obj.outWareHouseId}" class="textBox" type="text"/>
			    <font>调入仓库：</font><input name="inWareHouseName" _imp="true" _class="warehouse" id="inWareHouseName" value="${isDetail ? obj.inWareHouseName : obj.inWareHouseId}" class="textBox" type="text"/>
		        <font>出仓人：</font><input _imp="true" id="outMemberName" name="outMemberName" _class="outMember-combogrid" value="${obj.outMemberName}" class="memberBox textBox" type="text"/>
			</p>
			<p>
			    <font>入仓人：</font><input _imp="true" id="inMemberName" name="inMemberName" _class="member-combogrid" value="${obj.inMemberName}" class="memberBox textBox" type="text"/>
...
<c:otherwise>
initEdit('${param.flag}','${obj.recordStatus}','dcd','调仓单',${obj.details});
</c:otherwise>
</c:choose>
</script>
</body>
