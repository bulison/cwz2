	  ...
	  <fool:tagOpt optCode="tcdSearch">
	    ...
	    <div class="input_div">
	      <form id="search-form">
	        ...
	        <p>调入仓库:<input id="search-inWarehouse" _class="warehouse" name="inWareHouseId"/></p><!-- <input id="search-status"/> -->
	        <p>调出仓库:<input id="search-outWarehouse" _class="warehouse" name="outWareHouseId"/></p>
	        <p>收货人：<input id="select-inMemberName" _class="inmember-combogrid" name="inMemberName" class="textBox"/><input type="hidden" name="inMemberId" id="select-inMemberId" /></p>
...
$('#billList').jqGrid({
	...
	colModel:[
        	...
        	{name:'outWareHouseName',label:'调出仓库',align:"center",sortable:true,width:100},
        	{name:'inWareHouseName',label:'调入仓库',align:"center",sortable:true,width:100},
	  		{name:'outMemberName',label:'出仓人',align:"center",sortable:true,width:100},
        	{name:'inMemberName',label:'入仓人',align:"center",sortable:true,width:100},
	      ...
	      gridComplete:function(){
	    	  	<fool:tagOpt optCode="tcdAction2">//</fool:tagOpt>$('.btn-del').remove();
				<fool:tagOpt optCode="tcdAction3">//</fool:tagOpt>$('.btn-copy').remove();
				<fool:tagOpt optCode="tcdAction4">//</fool:tagOpt>$('.btn-approve').remove();
				<fool:tagOpt optCode="tcdAction5">//</fool:tagOpt>$('.btn-cancel').remove();
	    	  warehouseAll();
	      }
