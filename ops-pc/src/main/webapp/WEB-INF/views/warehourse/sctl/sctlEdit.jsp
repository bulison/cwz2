		...
		<div class="in-box" id="list2">
			...
			<!-- 
			 ...
			 <p>
			    ...
			    <font>退料员：</font><input _imp="true" type="text" _class='member-combogrid' class="textBox"  id="inMemberName" name="inMemberName" value="${obj.inMemberName}"/>
			 </p>
			 <p>
			    <font>入仓仓库：</font><input  id="inWareHouseName" type="text" _class="warehouse" name="inWareHouseName" class="textBox" value="${isDetail ? obj.inWareHouseName : obj.inWareHouseId}"/>
			    <font>计划入仓完成日期：</font><input _imp="true" _class="datebox" type="text" id="planEnd" name="endDate" class="textBox" data-options='{required:true,novalidate:true,validType:"dateCompar[\"#billDate\",-1,\"计划完成日期不能早于单据日期\"]"}' value="${obj.endDate}"/>
			 </p>
			 <p>
			 	<font>备注：</font><input style="width:519px;" data-options="validType:'maxLength[200]'" type="text" id="describe" name="describe" class="textBox" value="${obj.describe}"/>
			 </p> 
