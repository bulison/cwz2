...
//如果iframe内超时会跳转到登录页面，这时让外框架直接跳转到登录页面
if (window != top) 
	    ...
	    <div class="context" >
	        ...
	        <div class="context-sider">
	            ...
	            <div class="context-sider-login">
	                <form action="${ctx}/login" method="post" onsubmit="return submitForm();">
	                    <table cellpadding="5">
	                        <thead>
	                            <tr>
	                        ...
	                        <tbody>
	                        	<c:if test="${not empty(sessionScope['OPS_SECURITY_EXCEPTION'])}">
	                        	<tr class="msg">
							    	<td colspan="4" style="color:red;">${sessionScope['OPS_SECURITY_EXCEPTION']}</td>
	                        	</tr>
							    </c:if>
							    <c:remove var="OPS_SECURITY_EXCEPTION" scope="session" />
		                        <tr>
		                            <td class="from-lable">用户名:</td>
		                            <td colspan="3"><input class="easyui-textbox easyui-validatebox" type="text" id="userCode" name="username" value="${defaultLoginName}" style="width: 222px;  height: 35px;" data-options="prompt:'账号、邮箱',iconCls:'icon-man',iconWidth:38,iconAlign:'left'"></td>
		                        </tr>
		                        <tr>
		                            <td class="from-lable">密码:</td>
		                            <td colspan="3"><input class="easyui-textbox easyui-validatebox" type="password" id="password" name="password" value="${defaultPassword}" style="width: 222px;  height: 35px;" data-options="prompt:'请输入密码',iconCls:'icon-lock',iconWidth:38,iconAlign:'left'"></td>
		                        </tr>
		                       <tr>
