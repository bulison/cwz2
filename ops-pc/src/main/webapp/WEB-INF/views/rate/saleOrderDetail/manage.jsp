...
$('#detailsList').datagrid({
	url:getRootPath()+"/rate/ratesaleorderdetail/query",
	//fitColumns:true,
	singleSelect:true,
	showFooter:true,
	pagination:true,
	...
	columns:[[
	          ...
	          {field:"orderQuentity",title:'订货数量',width:80,formatter:numOut},
	          {field:"orderPrice",title:'订货价格',width:80,formatter:numOut},
	          {field:"orderAmount",title:'订货金额',width:80,formatter:numOut},
	          {field:"orderDate",title:'订货日期',width:80,formatter:dateFormatOut},
	          {field:"planDate",title:'计划完成日期',width:100,formatter:dateFormatOut},
	          {field:"deliveryQuentity",title:'已发货数量',width:100,formatter:numOut},
	          {field:"deliveryAmount",title:'已发货金额',width:100,formatter:numOut},
	          {field:"notDeliveryQuentity",title:'欠发货数量',width:100,formatter:numOut},
	          {field:"notDeliveryAmount",title:'欠发货金额',width:100,formatter:numOut},
	          {field:"firstDeliveryDate",title:'首次发货日期',width:100,formatter:dateFormatOut},
	          {field:"lastDeliveryDate",title:'末次发货日期',width:100,formatter:dateFormatOut},
	          ...
	          {field:"notReceiveAmount",title:'欠收金额',width:80,formatter:numOut},
	          {field:"goodsCost",title:'货品成本',width:80,formatter:numOut},
	          {field:"lastGoodsCost",title:'最近货品成本',width:100,formatter:numOut},
	        ...
	        onLoadSuccess:function(data){
	        	...
	        	myvalue.saleAmount = myvalue.orderQuentity = myvalue.orderAmount = myvalue.deliveryQuentity 
	        	= myvalue.deliveryAmount = myvalue.notDeliveryQuentity = myvalue.notDeliveryAmount 
	        	= myvalue.returnQuentity = myvalue.returnAmount = myvalue.receivedAmount
	        	= myvalue.notReceiveAmount = myvalue.saleCharge = myvalue.goodsCost = myvalue.lastGoodsCost = 0;
	        	for(var i=0; i<length; i++){
	        		myvalue.saleAmount = myvalue.saleAmount + row[i].saleAmount;
	        		myvalue.orderQuentity = myvalue.orderQuentity + row[i].orderQuentity;
	        		myvalue.orderAmount = myvalue.orderAmount + row[i].orderAmount;
	        		myvalue.deliveryQuentity = myvalue.deliveryQuentity + row[i].deliveryQuentity;
	        		myvalue.deliveryAmount = myvalue.deliveryAmount + row[i].deliveryAmount;
	        		...
	        		myvalue.lastGoodsCost = myvalue.lastGoodsCost + row[i].lastGoodsCost;
	        	}
